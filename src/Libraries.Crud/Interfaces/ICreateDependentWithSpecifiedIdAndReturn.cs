...
namespace Nexus.Link.Libraries.Crud.Interfaces
{
    ...
    /// </summary>
    public interface ICreateDependentWithSpecifiedIdAndReturn<TModel, in TId, in TDependentId> : ICreateDependentWithSpecifiedIdAndReturn<TModel, TModel, TId, TDependentId>, ICrudableDependent<TModel, TId, TDependentId>
    {
    }
    ...
    /// Examples: A list of rows on an invoice, a list of attributes of an object, the contact details of a person.
    /// </summary>
    public interface ICreateDependentWithSpecifiedIdAndReturn<in TModelCreate, TModel, in TId, in TDependentId> : ICrudableDependent<TModelCreate, TModel, TId, TDependentId>
        where TModel : TModelCreate
    {
        ...
        Task<TModel> CreateWithSpecifiedIdAndReturnAsync(TId masterId, TDependentId dependentId, TModelCreate item, CancellationToken cancellationToken  = default);
    }
}
