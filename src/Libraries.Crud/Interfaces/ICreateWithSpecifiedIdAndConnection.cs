...
namespace Nexus.Link.Libraries.Crud.Interfaces
{
    ...
    public interface ICreateWithSpecifiedIdAndConnection<TModel, TId> : ICreateWithSpecifiedIdAndConnection<TModel, TModel, TId>
    {
    }
    ...
    public interface ICreateWithSpecifiedIdAndConnection<in TModelCreate, TModel, in TId> : ICrudable<TModel, TId>
    where TModel : TModelCreate
    {
        ...
        Task CreateWithSpecifiedIdAsync(TId id, TModelCreate item, IDbConnection connection, CancellationToken token = default(CancellationToken));
        ...
        Task<TModel> CreateWithSpecifiedIdAndReturnAsync(TId id, TModelCreate item, IDbConnection connection, CancellationToken token = default(CancellationToken));
    }
}
