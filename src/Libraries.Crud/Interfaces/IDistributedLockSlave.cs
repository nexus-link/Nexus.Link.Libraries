...
namespace Nexus.Link.Libraries.Crud.Interfaces
{
    ...
    [Obsolete("Use IDistributedLockDependent. Obsolete since 2021-08-27.")]
    public interface IDistributedLockSlave<TId> : ICrudable<TId>
    {
        /// <summary>
        ...
        /// </remarks>
        Task<SlaveLock<TId>> ClaimDistributedLockAsync(TId masterId, TId slaveId, CancellationToken token = default);
        ...
        /// <param name="token">Propagates notification that operations should be canceled</param>
        Task ReleaseDistributedLockAsync(TId masterId, TId slaveId, TId lockId, CancellationToken token = default);
    }
}
