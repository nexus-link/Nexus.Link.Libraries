...
namespace Nexus.Link.Libraries.Crud.Interfaces
{
    ...
    public interface IDistributedLockSlave<TId> : ICrudable<TId>
    {
        ...
        /// </remarks>
        Task<SlaveLock<TId>> ClaimDistributedLockAsync(TId masterId, TId slaveId, CancellationToken token = default(CancellationToken));
        ...
        /// <param name="token">Propagates notification that operations should be canceled</param>
        Task ReleaseDistributedLockAsync(TId masterId, TId slaveId, TId lockId, CancellationToken token = default(CancellationToken));
    }
}
