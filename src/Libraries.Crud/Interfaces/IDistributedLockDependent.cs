...
namespace Nexus.Link.Libraries.Crud.Interfaces
{
    ...
    public interface IDistributedLockDependent<TId, TDependentId> : ICrudableDependent<TId, TDependentId>
    {
        ...
        /// </remarks>
        Task<DependentLock<TId, TDependentId>> ClaimDistributedLockAsync(TId masterId, TDependentId dependentId, CancellationToken token = default);
        ...
        /// <param name="token">Propagates notification that operations should be canceled</param>
        Task ReleaseDistributedLockAsync(TId masterId, TDependentId dependentId, TId lockId, CancellationToken token = default);
    }
}
