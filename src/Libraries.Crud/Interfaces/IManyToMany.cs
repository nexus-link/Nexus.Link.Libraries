...
namespace Nexus.Link.Libraries.Crud.Interfaces
{
        ...
        where TManyToManyModel : TManyToManyModelCreate
    {
        ...
        /// </summary>
        Task DeleteReferencedItemsByReference1(TId id, CancellationToken cancellationToken  = default);
        #endregion
        ...
        /// </summary>
        Task DeleteReferencedItemsByReference2(TId id, CancellationToken cancellationToken  = default);
        #endregion
    }
}
